...
export default function MobileVMark2() {
  ...
  return (
    <View className="w-full flex flex-col space-y-6 h-auto mt-5 mb-5">
      <ImageBackground source={mark2} className="w-full h-[352px] bg-cover rounded-lg mb-5" />

      <View className="">
        <Text className="text-brown uppercase tracking-[4px] font-semibold">New Product</Text>
        <View className="flex">
        ...
        <View className="flex flex-row items-center mt-6 gap-2">
          ...
          <TouchableOpacity 
            onPress={() => console.log("Added to cart:", mark2s)}
            activeOpacity={0.8}
