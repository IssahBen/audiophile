  ...
  return (
    <View className="w-full flex flex-col smallhide largehide">
      ...
      <View className="flex  gap-4 mt-10 mb-10">
        <Image source={mark2g1} className="w-full h-[174px] mobilevmark2i1 bg-cover rounded-xl" />
        <Image source={mark2g2} className="w-full h-[174px] mobilevmark2i2 bg-cover rounded-xl" />
        <Image source={mark2g3} className="w-full h-[368px] mobilevmark2i3 bg-cover rounded-xl" />
      </View>
    </View>
  );
}